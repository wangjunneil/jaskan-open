	...
	return function(e) {
		...
		function(e, t, n) {
			...
			e.exports = function(e) {
				...
				// var player_background_image = 'https://fla.cdn.bosyun.com/other/vod-poster-' + Math.floor(Math.random()*5+1) + '.jpg?imageView2/0/format/webp/q/75';
				var player_background_image = 'https://fla.cdn.bosyun.com/other/player-bg-' + Math.floor(Math.random()*5+1) + '.jpg?imageView2/0/format/webp/q/75';
